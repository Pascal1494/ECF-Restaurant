 ...
 */
final class Version20230515162404 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955DBFD579D FOREIGN KEY (allergy_id) REFERENCES allergy (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
