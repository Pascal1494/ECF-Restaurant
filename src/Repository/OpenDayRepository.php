...
/**
 * @extends ServiceEntityRepository<OpenDay>
 *
...
class OpenDayRepository extends ServiceEntityRepository
{
    ...
    public function save(OpenDay $entity, bool $flush = false): void
    {
    ...
    public function remove(OpenDay $entity, bool $flush = false): void
    {
